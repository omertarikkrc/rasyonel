...
from deneme8 import cx,cy #importing ml's data
...
current_horizantal_field_of_view = height*tan(camera_horizontal_angle) #anlik yatay field of view 
current_vertical_field_of_view = height*tan(camera_vertical_angle)    #anlik dikey field of view

additive_degree_for_frame_horizantal =current_horizantal_field_of_view/0.084    #it varies by 0.00001 degrees at every 0.084 m for istanbul eklenecek coordinate miktari kose coordinate icin
additive_degree_for_frame_vertical = current_vertical_field_of_view/0.11113295   #it varies by 0.00001 degrees at every 0.11113295 
# additive_degree_for_frame_horizantal = round(additive_degree_for_frame_horizantal,0)
# additive_degree_for_frame_vertical= round(additive_degree_for_frame_vertical,0) # hata alirsam duzeltcem




#frame's corner coordinates
...
# according to ml's data target's lat and lon
target_lat = ((2*additive_degree_for_frame_horizantal)*x_axis_ratio)+ (lat_mav-additive_degree_for_frame_horizantal)
target_lon = ((2*additive_degree_for_frame_vertical)*y_axis_ratio)+(lon_mav-additive_degree_for_frame_vertical)
#target coordination
target_coordination = LocationGlobalRelative(target_lat,target_lon)




#i don't know why i have written this code
